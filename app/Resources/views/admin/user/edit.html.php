<form class="form-horizontal" action="/admin/users/edit/<?= $user_edit['id'] ?>" method="post">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4 ">
                <input type="text" class="form-control" id="user_fullName" placeholder="Име" name="user[fullName]"
                       required value="<?= $user_edit['fullname'] ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="password" class="form-control" id="user_password_first" placeholder="Нова парола"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="password" class="form-control" id="user_password_second" placeholder="Потвърди паролата"
