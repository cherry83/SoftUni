            <form class="form-horizontal" action="/admin/pictures/delete/<?=$picture['id']?>" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 ">
                            <input type="text" class="form-control" id="title" placeholder="Име " name="picture[name]" value="<?=$picture['title']?>" readonly>
                        </div>
                    </div>
                    
                    <div class="form-group">
                            <img src="/outlines/<?=$picture['file']?>" class="col-sm-4 col-sm-offset-4" style="border: 1px solid gray">
                    </div>
